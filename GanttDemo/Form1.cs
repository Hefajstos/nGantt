...
namespace GanttDemo
{
    public partial class Form1 : Form
    {
        ...
        private void CreateData(DateTime minDate, DateTime maxDate)
        {
            ...
            // Create the data
            GanttRowGroup rowgroup1 = ganttControl1.CreateGanttRowGroup("HeaderdGanttRowGroup");
            ...
            GanttRowGroup rowgroup2 = ganttControl1.CreateGanttRowGroup("ExpandableGanttRowGroup", true);
